    ...
    <div class="container">
        <div class="breadcrumb">
            <ul>
                ...
                <li itemscope="" >
                    <a itemprop="url" href="" title="Sản phẩm chính hãng"><span itemprop="title">Tài khoản</span></a>
                </li>

                <li itemscope="" >
                    <a itemprop="url" href="" title="Whey protein"><span itemprop="title">Đặt lại mật khẩu
</span></a>
                </li>
        ...
        <div class="auth" style="background: white;">
            <form class="from_cart_register" action="" method="post" style="width: 500px;margin:0 auto;padding: 30px 0">
                ...
                <div class="form-group">
                    ...
                    <input name="email" id="name" required="" type="email" class="form-control" placeholder="buisontung1997@gmail.com">
