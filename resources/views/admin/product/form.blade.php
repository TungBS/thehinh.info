                ...
                <div class="form-group ">
                    ...
                    <select name="pro_category_id" class="form-control">
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id}}" {{ ($product->pro_category_id ?? 0 == $category->id) ? "select='selected'" : ""}}>
             ...
             <div class="box-body">
                <div class="form-group col-sm-3">
                    ...
                    <select name="pro_country" class="form-control">
                        ...
                        <option value="3" {{ ($product->pro_country ?? '') == 3 ? "selected='selected'" : ""}}>Canada</option>
                        <option value="4" {{ ($product->pro_country ?? '') == 4 ? "selected='selected'" : ""}}>USA</option>
                        <option value="5" {{ ($product->pro_country ?? '') == 5 ? "selected='selected'" : ""}}>Thailand</option>
                    </select>
                </div>
                    <div class="form-group col-sm-3">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <input type="text" class="form-control" name="pro_resistant" value="{{ $product->pro_resistant ?? ''}}" placeholder="Số lần sử dụng">
                    </div>
                    <div class="form-group col-sm-3">
