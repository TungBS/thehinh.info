                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sd_target">
                                    <option value="1" {{ $slide->sd_target == 1 ? "selected='selected'" : ""}}>blank</option>
                                    <option value="2" {{ $slide->sd_target == 2 ? "selected='selected'" : ""}}>self</option>
                                    <option value="3" {{ $slide->sd_target == 3 ? "selected='selected'" : ""}}>parent</option>
                                    <option value="4" {{ $slide->sd_target == 4 ? "selected='selected'" : ""}}>top</option>
                                </select>
                            </div>
                        </div>
                    <div class="col-md-3">                          
                		...
                		<div class="col-md-8">
                                    <h3 class="box-title">Ảnh bìa</h3>
                                    <div class="box-body block-images">
                                        <div style="margin-bottom: 10px"> <img src="/images/no-image.jpg" onerror="this.onerror=null;
                                        this.src='/images/no-image.jpg';" alt="" class="img-thumbnail" style="width: 100%;height: 350px;"> </div>
         				...
         				<div class="col-md-12">
         					<div class="box-footer text-center">
							    <a href="{{ route('admin.slide.index')}}"  class="class btn btn-danger">Quay lại <i class="fa fa-undo"></i></a>
